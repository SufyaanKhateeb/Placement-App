...
const CompanyRegistrationForm = lazy(() => import("./app/form-elements/CompanyRegistrationForm"));
...
const StudentNotRegistered = lazy(() => import("./app/error-pages/StudentNotRegistered"));
	...
	return (
		<Suspense fallback={<Spinner animation="border" variant="light" />}>
			<Switch>
				...
				<Route path="/login" component={isLoggedIn ? Error404 : Login} />
				<Route path="/register" component={isLoggedIn ? Error404 : Register} />

				<Route path="/error-pages/error-404" component={Error404} />
				<Route path="/error-pages/error-500" component={Error500} />
				{/* student */}
				<Route path="/student" exact component={studentLoggedIn ? Error404 : Error404} />
				<Route path="/student/jobs/job-openings" component={studentLoggedIn ? JobApplicationsTable : Error404} />
				<Route path="/student/jobs/pending-applications" component={studentLoggedIn ? BasicTable : Error404} />
				<Route path="/student/offers" component={studentLoggedIn ? BasicTable : Error404} />
				<Route path="/student/feedback" component={studentLoggedIn ? BasicElements : Error404} />
				<Route path="/student/profile" component={studentLoggedIn ? Dashboard : Error404} />
				<Route path="/student-register" component={studentLoggedIn ? StudentRegister : Error404} />
				<Route path="/student-not-verified" component={studentLoggedIn ? StudentNotRegistered : Error404} />
				<Route
					exact
					path="/student/stats"
					component={() => {
				...
				{/* company */}
				<Route exact path="/company/home" component={companyLoggedIn ? Dashboard : Error404} />
				<Route exact path="/company/applications" component={companyLoggedIn ? BasicTable : Error404} />
				<Route exact path="/company/feedback" component={companyLoggedIn ? BasicElements : Error404} />
				{/* company */}
				...
				<Route exact path="/stats" component={adminLoggedIn ? ChartJs : Error404} />
				<Route path="/tables/student-table" component={adminLoggedIn ? BasicTable : Error404} />
				<Route path="/tables/company-table" component={adminLoggedIn ? BasicTable : Error404} />
				{/* admin */}

				{!isLoggedIn ? <Redirect from="/" to="/login" /> : <Redirect to="/" />}
			</Switch>
		</Suspense>
	);
}
